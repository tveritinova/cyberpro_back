...
class BackApiTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.player = {'name': 'Test Player', 'nickname': 'test_player', 'country': 'China', 'is_cap': False}
    ...
    def test_api_can_post_and_get_all_players(self):
        ...
        self.player['team_id'] = self.first_team_id
    ...
    def test_api_can_post_and_get_tournaments_and_one(self):
    ...
    def test_matches(self):
        self.match['tournament_id'] = self.tournament_id
        self.match['first_team_id'] = self.first_team_id
        self.match['second_team_id'] = self.second_team_id
    ...
    def test_players_transactions(self):
        self.transaction['player_id'] = self.player_id
        self.transaction['from_team_id'] = self.first_team_id
        self.transaction['to_team_id'] = self.second_team_id
